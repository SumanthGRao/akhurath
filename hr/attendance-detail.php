    ...
    <div class="portal-card portal-card--tasks admin-shell">
      <header class="admin-head">
        <div>
          ...
          <p class="portal-lead admin-head__meta"><?php echo h($monthLabel); ?> calendar and totals.</p>
        </div>
        <div class="admin-head__actions">
          <a class="btn btn--ghost btn--sm" href="<?php echo h(base_path('hr/index.php?year=' . $report['year'] . '&month=' . $report['month'])); ?>">← All editors</a>
      ...
      <div class="admin-attendance-detailcard">
        <?php require AKH_ROOT . '/admin/includes/attendance-calendar-article.php'; ?>
      </div>
    </div>
  </main>
